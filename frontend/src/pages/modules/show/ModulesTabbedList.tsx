...
const ModulesTabbedList = () => {
    ...
    const tabOptions = [];
    if (currentModules && Object.keys(currentModules).length > 0) tabOptions.push({ name: 'Current', tasks: currentModules });
    if (upcomingModules && Object.keys(upcomingModules).length > 0) tabOptions.push({ name: 'Upcoming', tasks: upcomingModules });
    if (completedModules && Object.keys(completedModules).length > 0)  tabOptions.push({ name: 'Completed', tasks: completedModules });
